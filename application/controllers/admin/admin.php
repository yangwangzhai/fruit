...
class admin extends Content
{
    ...
    public function save ()
    {
        ...
        if ($id) { // 修改 ===========
            ...
            show_msg('修改成功！', ($_SESSION['groupid']==1)?$_SESSION['url_forward']:'./index.php?d=admin&c=admin&m=index&m=edit&id='.$this->session->userdata('id'));
        } else { // ===========添加 ===========
            $data['addtime'] = time();
            $query = $this->db->insert($this->table, $data);
            show_msg('添加成功！', ($_SESSION['groupid']==1)?$_SESSION['url_forward']:'./index.php?d=admin&c=admin&m=index&m=edit&id='.$this->session->userdata('id'));
        }
    }
